...
const Greetings = () => {
    ...
    // Register the prompt preloader value using the custom hook `usePromptPreloader`.
   ...
   return (
    ...
    { promptPreloaderValue ?(
       <PromptPreloader 
       promptValue={promptPreloaderValue}/>
    ) :(
       <div className="grid place-content-center h-full">
            ...
            dark:text-dark-onSurfaceVariant">
               ...
               className="bg-gradient-to-r from-teal-400 from-0% via-cyan-500 via-56% to-transparnt to-75% bg-[length:3500%_100%] bg-[100%_0] bg-clip-text text-transparent">Hello,{user.name.split(' ').at()}</motion.span>
               <br />
               <motion.span 
              initial={{opacity:0}}
              animate={{opacity:1}}
